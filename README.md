...
Pluvite é uma plataforma web desenvolvida para monitoramento de riscos climáticos, comunicação de alertas e participação cidadã durante eventos relacionados a desastres naturais.
...
- Publicação de ocorrências pela população
- Upload de imagens
