...
export default function SelecaoPerfil() {
  ...
  return (
    <main className="relative h-screen w-full flex items-start pt-33 justify-center p-6 overflow-hidden bg-slate-50">
      ...
      {/* CARD DE SELEÇÃO - Padronizado com Login e Cadastro */}
      <div className="flex flex-col justify-center items-center max-w-2xl w-full bg-white rounded-[2.5rem] shadow-2xl shadow-zinc-900/50 p-10 z-10 border border-slate-100">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-lg">
          ...
          <Link 
            ...
            className="group flex flex-col items-center p-6 bg-zinc-50 rounded-3xl border-2 border-transparent hover:border-[#256ffe] hover:bg-white transition-all duration-300 shadow-sm active:scale-95"
          >
            <div className="bg-white p-4 rounded-2xl shadow-sm mb-4 group-hover:shadow-md transition-all">
              <UserRound size={32} className="text-zinc-400 group-hover:text-[#256ffe] transition-colors" />
            </div>
          ...
          >
            <div className="bg-white p-4 rounded-2xl shadow-sm mb-4 group-hover:shadow-md transition-all">
              <Briefcase size={32} className="text-zinc-400 group-hover:text-[#256ffe] transition-colors" />
            </div>
