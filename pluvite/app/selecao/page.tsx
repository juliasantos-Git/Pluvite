...
export default function SelecaoPerfil() {
  return (
    <main className="relative min-h-screen w-full flex items-center justify-center p-6 overflow-hidden bg-slate-50">
      ...
      {/* CARD DE SELEÇÃO */}
      <div className="flex flex-col justify-center items-center max-w-2xl w-full bg-white rounded-4xl shadow-2xl p-12 z-10 mt-15">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 w-full">
          ...
          <Link
            ...
            className="group flex flex-col items-center p-8 bg-zinc-50 rounded-3xl border-2 border-transparent hover:border-blue-500 hover:bg-blue-50/30 transition-all duration-300 shadow-sm hover:shadow-md"
          >
          ...
          <Link
            ...
            className="group flex flex-col items-center p-8 bg-zinc-50 rounded-3xl border-2 border-transparent hover:border-blue-600 hover:bg-blue-50/30 transition-all duration-300 shadow-sm hover:shadow-md"
          >
            <div className="bg-white p-4 rounded-2xl shadow-inner mb-4 group-hover:scale-110 transition-transform">
              <Briefcase
                size={40}
                className="text-zinc-400 group-hover:text-blue-700"
              />
            </div>
        ...
        <div className="mt-10">
          <Link
            href="/login"
            className="text-zinc-400 hover:text-blue-600 font-medium transition-colors"
          >
            Já tem conta? Entrar
          </Link>
        </div>
