    ...
    <main className="min-h-screen bg-blue-950 flex items-start justify-center pt-10 pb-10 overflow-y-auto">
      <div className="bg-blue-600 rounded-3xl p-6 w-95 text-white text-center">
        <div className="flex gap-2 mb-4">
          <input // O input cria o campo onde o usuário digita o nome da cidade.
            type="text"
          ...
          />
          <button
            onClick={buscarCidade} // Executa a função de busca quando o botão é clicado.
            className="bg-blue-500 rounded-xl px-3 py-2 text-sm cursor-pointer hover:scale-105 transition-all duration-100"
          >
            <Search />
          </button>
        </div>
        ...
        <div className="mt-4 text-left">
          <p className="text-sm font-bold mb-2 ml-7">Hoje</p>
