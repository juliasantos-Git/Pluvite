    ...
    <main className="min-h-screen w-full flex items-center justify-center -mt-15 bg-slate-50 p-3 sm:p-5 md:p-6 font-sans antialiased relative overflow-hidden">
      ...
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-6 items-center relative z-10">
        ...
        <div className="text-slate-900 space-y-4 pr-0 md:pr-6 text-center md:text-left flex flex-col items-center md:items-start">
          ...
          <div className="hidden md:flex items-center gap-3 text-[11px] text-[#0f35a0] font-bold uppercase tracking-wider">
        ...
        <div className="flex justify-center md:justify-end w-full relative z-10">
          <div className="w-full max-w-[380px] bg-white rounded-2xl shadow-2xl shadow-slate-900/60 border border-slate-200 p-5 sm:p-6">
            <Link href="/">
              <img
                src="/PluviteIcon.jpg"
                alt="Pluvite Icon"
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <button
                type="submit"
                disabled={carregando}
                className="w-full bg-[#0d1b54] hover:bg-[#0d163b] active:bg-[#061560] text-white text-sm font-bold py-2.5 rounded-xl cursor-pointer shadow-md shadow-blue-500/10 flex items-center justify-center gap-2"
              >
                {carregando ? (
            ...
            <div className="space-y-2">
              <button
                ...
                className="w-full bg-[#0f35a0] hover:bg-[#091f75] text-white text-sm font-semibold py-2 px-4 rounded-xl flex items-center justify-center gap-2 cursor-pointer shadow-sm disabled:opacity-50"
              >
              ...
              <button
                ...
                className="w-full bg-zinc-200 hover:bg-slate-300 border border-slate-200 text-black text-sm font-semibold py-2 px-4 rounded-xl flex items-center justify-center gap-2 cursor-pointer shadow-sm disabled:opacity-50"
              >
